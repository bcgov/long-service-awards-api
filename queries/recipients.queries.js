...
const recipientQueries = {
  ...
  findAll: (filter, ignore = [], schema) => {
    ...
    // split off attached table name from head of orderby - this gets sent from frontend when using column header search
                ...
                ${selections},
                  ...
                  LEFT JOIN (
                    ...
                    json_build_object('id', ao.id,
                                     'name', ao.name,
                                     'abbreviation', ao.abbreviation) AS attending_organization
