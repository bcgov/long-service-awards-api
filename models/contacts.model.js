...
const schema = {
  ...
  attachments: {
    office_address: {
      ...
      attach: async (address, contact) => {
        await Address.attach(address, contact, "office_address");
      },
    },
    personal_address: {
      model: Address,
      get: async (id) => {
        return await Address.findAttachment(id, "personal_address", schema);
      },
      attach: async (address, contact) => {
        await Address.attach(address, contact, "personal_address");
      },
    },
  },
};
